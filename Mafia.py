...
#AUTHOR : IBIFURO SAMUEL GEORGE (MELANIN)
#OPEN SOURCE :)
...
def main():
	...
	print("\033[96;1m  [J] JOIN MELANIN GROUP \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/Melanin23/melanin")
